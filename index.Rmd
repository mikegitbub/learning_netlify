...
* Mettre le fichier dans le dossier crée à l'étape précédente pour les fichiers `markdown`
...
## Créer un compte Nelify, le connecter au compte github, deployer le site et le renommer
